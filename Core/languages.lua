...
-- Tongues.Language: Vulpera - aka Vulperan -- courtasy of Abstergent  & Hurakanzemi
Tongues.Language["Vulpera"] = {
	[1] = { "y", "i", "o" },
	[2] = { "ik", "da", "au", "uk", "yy", "aw", "yi", "pa", "wa", "ii", "ak", "ho", "oo", "ao", "wo", "po" },
	[3] = { "gav", "hau", "woo", "yap", "arf", "wan", "bow", "iiy", "iyw", "vuf", "aoo", "haf", "pow", "bau", "yip", "vuu", "gua" },
	[4] = { "guau", "bork", "keff", "lall", "ahee", "woef", "ouah", "bhuh", "blaf", "yaap", "yiip", "youw", "joff", "ghav", "woof", "meon", "gheu", "hyto", "wooo", "yiuw", "wauw", "vuuf", "waou", "ring" },
	[5] = { "lally", "hatti", "wauwn", "youwn", "ouahn", "yipyi", "yiuwn", "meong", "waouh", "wanwa", "woooo", "bauba", "hittu", "caica", "tchof", "hytou", "gedin", "hauha" },
	[6] = { "bhuhbu", "yipyip", "tchoff", "geding", "baubau", "caicai", "wanwan", "grrbor", "guaugu", "hauhau", "hattii", "frakak", "wooowo", "aheeah" },
	[7] = { "wuffvuw", "vuufwuf", "joffwau", "bhuhbuh", "frakaka", "aheeaha", "grrbork", "wooowoo", "guaugua", "wuffwoe", "borkbor", "blafbla", "gheughe" },
	[8] = { "aheeowow", "blafblaf", "ghavyouw", "wuffwoef", "woefyouw", "vuufwuff", "guauguau", "wuffvuwn", "gheugheu", "borkbork", "bhuhwauw", "keffgedi" },
	[9] = { "borkwanwa", "ghavyouwn", "vuufhatti", "aheeowown", "bhuhwauwn", "joffwauwn", "woefyouwn", "keffgedin", "blafhauha", "woofhauha" },
	[10] = { "keffgeding", "vuufhattii", "blafhauhau", "woofhauhau", "borkwanwan" }
};
Tongues.Language["Vulpera"]["ignore"] = {
	"Vol'dun", "Zuldazar", "Nazmir", "Freehold", "Sethrak", "Sethraliss", "Kiro", "Nisha", "Meerah", "Jena", "Korthek", "Vorrik", "Talanji", "Eudora"
};
Tongues.Language["Vulpera"].Difficulty = {
	["default"] 	= 100;
...
["dwarf"] = "dvergr",
["night elf"] = "dökkálfar",
["draenei"] = "ginnung kvikindi",
["gnome"] = "nissër",
["worgen"] = "manlíkan blóta",
["wolf"] = "gjalpar skær",
["priest"] = "prestr",
["shaman"] = "margkunnigr",
["druid"] = "skógr seid",
...
["warrior"] = "þor-móþR",
["rogue"] = "þjófr",
["deathknight"] = "draugr þor-móþR",
["mage"] = "seid",
["paladin"] = "dagr þor-móþR",
["undercity"] = "undanstaðr",
["silvermoon"] = "silfrmáni" ,
["thunder bluff"] = "graðungr bjarg",
["orgrimmar"] = "grœnn kykvendi staðr",
["stormwind"] = "stormrvindr",
["ironforge"] = "jarnsmíða",
